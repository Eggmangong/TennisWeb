      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-x-6">
          {[...baseNav,
            ...(isAuthenticated
              ? [
                  { name: 'Find a Partner', href: '/match' },
          ...
          {/* AI Assistant pill button in header
          <button
            type="button"
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                {/* <button
                  onClick={() => { window.dispatchEvent(new Event('open-chatbot')); setMobileMenuOpen(false); }}
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white bg-indigo-600 hover:bg-indigo-500 w-full text-left"
                >
                  <span className="inline-flex items-center gap-2"><ChatBubbleLeftRightIcon className="h-5 w-5" /> AI Assistant</span>
                </button> */}
                {isAuthenticated && (
                  <button
